...
namespace AudioSystem
{
    ...
    public class AudioManager : MonoBehaviour
    {
        ...
        {
            return Play(clip, group, Vector3.zero, GetEffectiveVolume(group), settings_?.GetRandomPitch() ?? 1f, false);
        }
        ...
        public AudioHandle Play(AudioClip clip, AudioGroup group, float volume_multiplier)
        {
            ...
            return Play(clip, group, Vector3.zero, base_volume * volume_multiplier, settings_?.GetRandomPitch() ?? 1f, false);
        }
        ...
        {
            float base_volume = GetEffectiveVolume(group);
            return Play(clip, group, position, base_volume * volume_multiplier, settings_?.GetRandomPitch() ?? 1f, false);
        }
        ...
        {
            float base_volume = GetEffectiveVolume(group);
            return Play(clip, group, Vector3.zero, base_volume * volume_multiplier, settings_?.GetRandomPitch() ?? 1f, true);
        }
        ...
        {
            float base_volume = GetEffectiveVolume(group);
            return Play(clip, group, position, base_volume * volume_multiplier, settings_?.GetRandomPitch() ?? 1f, true);
        }
